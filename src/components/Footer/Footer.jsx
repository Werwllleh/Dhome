    ...
    <div id="contacts" className={s.body}>
      <div className="container">
        <div className={s.footer_content}>
          <div className={s.row}>
            <div className={s.col_info}>
              <div className={s.logo}>
                <span className={s.logo_icon}>
                  <svg
                    width="30"
                    height="30"
                    viewBox="0 0 30 30"
                ...
                <span className={s.logo_text}>D’home</span>
              </div>
              <div className={s.text}>
                Строим дома по канадской технологии. Производство и реализация
                СИП панелей, домокомплектов, строительство малоэтажных домов и
                коттеджей.
              </div>
            </div>
          ...
          <div className={s.row_rights}>
            2022 D’home inc. All Rights Reserved
          </div>
        </div>
      </div>
    </div>
